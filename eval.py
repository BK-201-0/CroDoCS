...
if __name__ == '__main__':
    ...
    if args.mode == "embedding":
        ...
        global_query_6 = np.concatenate((gpt_exquery_cocosoda_embedding, gpt_exquery_bge_embedding, gpt_exquery_unixcoder_embedding), axis=-1)
        global_target_6 = np.concatenate((code_cocosoda_embedding, code_bge_embedding, code_unixcoder_embedding), axis=-1)

        global_query_7 = np.concatenate((ds_exquery_cocosoda_embedding, ds_exquery_bge_embedding, ds_exquery_unixcoder_embedding), axis=-1)
        global_target_7 = np.concatenate((code_cocosoda_embedding, code_bge_embedding, code_unixcoder_embedding), axis=-1)

        global_query_5_1 = (global_query_5 + global_query_6 + global_query_7) / 3
        global_target_5_1 = global_target_5
